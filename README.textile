...
twitter_oauth
rss
bitly (if you want to shorten the URLs)
...
and an conf.yaml file will be created in the lib folder.  Fill it out.
...
Put your bit.ly username and api key into the conf.yaml file to be used in the code.

h2. cron

The idea is to setup cron to run the lib/run_twog.sh script.
...
bq. */15 * * * * jmeridth /Users/jasonmeridth/code/ruby/twog/lib/run_twog.sh
